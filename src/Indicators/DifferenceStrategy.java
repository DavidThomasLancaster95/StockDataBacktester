...
public class DifferenceStrategy {
    public static double calculateDifferenceStrategy(IndicatorDetails indicatorDetails, DayData dayData, Boolean onlyTrigger, IndicatorDetailsArray indicatorDetailsArray, int ifTrigger) {
